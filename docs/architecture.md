...
| **`k3s-wk-s-<rand>`** | Worker / Storage (x3)| `3011 - 3013` | DHCP (`192.168.0.x`) | `10.20.20.21 - 23` | 6 | 8192 MB | 32 GB | 80 GB | `/mnt/storage-data01` (XFS, Longhorn) | `colossus` |
